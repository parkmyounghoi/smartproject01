...
//          client.print("<br>\r\n");
//          client.print("</html>\r\n");
//          client.print("this is completed");
          break;
        }
        if (c == '\n') {
